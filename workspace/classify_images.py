...
def classify_images(images_dir, results_dic, model):
    ...
    # Iterate through every file in results_dic
    for key in results_dic:

      # inputs: path + filename  and  model 
      # images_dir (path) + filename (key)
      fullpath = images_dir + key

      # returns model_label as classifier label
      model_label = classifier(fullpath , model) 
       
       # Convert characters to lowercase and remove whitespace 
